...
static void test_csr(void)
{
    ...
    ret = mbedtls_x509write_csr_set_subject_name(&csr, "CN=stm32h5f4-ns,O=tfm");
    ...
    ret = mbedtls_x509write_crt_set_issuer_name(&crt, "CN=stm32h5f4-ca,O=tfm");
    check_mbed("mbedtls_x509write_crt_set_issuer_name", ret);
    ret = mbedtls_x509write_crt_set_subject_name(&crt, "CN=stm32h5f4-ns,O=tfm");
